...
import UploadKamus from './csv/UploadKamus';
...
const Settings = () => {
  ...
  if (content === 'UploadKamus') {
    return <UploadKamus onBack={() => setContent('main')} />;
  }
      ...
      <View style={styles.header}>
        ...
        >
          {languages.map((lang) => (
            ...
            >
              <Text style={styles.languageButtonText}>{lang.flag}</Text>
            </TouchableOpacity>
          ))}
        </ScrollView>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contactsContainer}>
          <ContactItem
            ...
            url="mailto:dharmachakra@gmail.com"
          />
          <ContactItem icon="phone" text="928349282" url="tel:928349282" />{' '}
          <ContactItem
            icon="instagram"
          ...
          <TouchableOpacity
            style={styles.contactCard}
            onPress={() => {
              setContent('UploadKamus');
            }}
          >
            <View style={styles.contactItem}>
              <View style={styles.contactIcon}>
                <FontAwesome5 name="upload" size={20} color="#4361ee" solid />
              </View>
              <Text style={styles.contactText}>Upload Kamus</Text>
              <FontAwesome5 name="arrow-right" size={16} color="#4361ee" />
            </View>
          </TouchableOpacity>
        </View>
